    ...
    public void getData() {
        new XHttpuTools() {
            ...
            public void initViews(ResponseInfo<String> arg0) {
                Log.d("result_succeed", arg0.result);
        ...
        }.datePost(DefineUtil.ORDER_LIST, AllOrderUrl.postAllOrderUrl(DefineUtil.USERID, DefineUtil.TOKEN, orderStatus), TransSucceedActivity.this);
    }
